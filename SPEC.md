...
todos:
  - id: scaffold
    content: Create repo at /Users/sigurd/src/ironman-pro-standings with Docker Compose, env files, FastAPI+Alembic, Next.js
    status: pending
  - id: models-scoring
...
Create a **new git repo** at [`/Users/sigurd/src/ironman-pro-standings`](/Users/sigurd/src/ironman-pro-standings). Put every file there. Do not touch sibling projects under `/Users/sigurd/src`.
